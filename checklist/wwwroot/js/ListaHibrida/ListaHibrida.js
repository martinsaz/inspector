...
function Inicializa() {
    $.ajax({
        ...
        async: true,
        contentType: 'application/json; charset=utf-8',
        url: '/ContestarListaHibrida/Inicializa',
        dataType: 'json',
        success: function (data) {
            if (data.perm != 1) {
    ...
    questions.forEach((q, index) => {
        ...
        if (q.valor === 1) {
            ...
            $.ajax({
                ...
                contentType: 'application/json; charset=utf-8',
                type: 'GET',
                url: '/ContestarListaHibrida/GetElementoOpciones',
                data: obj,
            ...
            var obj = { llav: q.idPregunta, tipoPregunta: "3" };
            $.ajax({
                dataType: 'json',
                contentType: 'application/json; charset=utf-8',
                type: 'GET',
...
document.getElementById('btEnviar').addEventListener('click', async () => {
    ...
    const checkCompletion = setInterval(() => {
        console.log("Intentando..." + contadorVideos + " - " + contadorUrls);
                ...
                didOpen: function () {
                    try {
                        $.ajax({
                            ...
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: '/ContestarListaHibrida/GuardarRespuesta',
                            ...
                            error: function (xhr, status, error) {
                                alert("Error al subir la lista. Detalle: " + " " + status + " " + error);
                                alert("Error al subir la lista. Detalle del error: " + error);
                                Swal.fire({
                                    text: 'No se pudo contestar la lista ' + error + status,
                                    icon: "error",
                                    buttonsStyling: false,
...
function ObtenerComboPrograma() {
    ...
    $('#cbPrograma').select2({
        ...
        ajax: {
            quietMillis: 150,
            url: "/ContestarListaHibrida/GetProgramasXAlumno",
            dataType: 'json',
            contentType: 'application/json; charset=utf-8',
...
function ObtenerSucursal() {
    ...
    $.ajax({
        ...
        async: true,
        contentType: 'application/json; charset=utf-8',
        url: '/ContestarListaHibrida/GetSucursales',
...
function ObtenerUsuariosXSucursal(selectedValue) {
    ...
    $.ajax({
        ...
        async: true,
        contentType: 'application/json; charset=utf-8',
        url: '/ContestarListaHibrida/GetUsuariosXSucursal',
        data: JSON.stringify(obj),
        dataType: 'json',
        success: function (data) {
...
function ConsultarPreguntas() {
    var obj = {};
    obj.idPrograma = $('#cbPrograma').val();
    obj.idLista = $('#cbEvaluaciones').val();

    $.ajax({
        'dataType': 'json',
        'contentType': 'application/json; charset=utf-8',
        'type': 'GET',
        'url': '/ContestarListaHibrida/GetData',
        'data': obj,
        'success': function (msg) {
            // console.log(msg.d)
            var idPregunta = '';
