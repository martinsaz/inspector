...
namespace checklist.Controllers.Reportes
{
    public class ReporteEstrellasController : Controller
    {
        ...
        public ReporteEstrellasController(IConfiguration configuration)
        {
        ...
        public async Task<ActionResult> Inicializa(string idEmpresa, string cadena, string empresa)
        {
            ...
            Opciones opc = await Utilerias.GetOpcion("03001001", idEmpresa, idRol, empresa, cadena);
        ...
        public async Task<IActionResult> GetData(string idLista, string idUsuario, string fechaInicia, string fechaFin, string idSucursal, string tipoPregunta, string idEmpresa, string cadena, string empresa)
        {
            ...
            string url = string.Format("{0}GetReporteEstrellas?idEmpresa={1}&empresa={2}&idLista={3}&tipoPregunta={4}&cadena={5}", Utilerias.UrlBase, idEmpresa, empresa, idLista, tipoPregunta, cadena);
        ...
        public async Task<IActionResult> GetListado([FromBody] dynamic parametros)
        {
            ...
            string fechaInicia = parametros.TryGetProperty("fechaInicia", out JsonElement fechaIniciaElement) ? fechaIniciaElement.GetString() : null;
            string fechaFin = parametros.TryGetProperty("fechaFin", out JsonElement fechaFinIniciaElement) ? fechaFinIniciaElement.GetString() : null;
            string idSucursal = parametros.TryGetProperty("idSucursal", out JsonElement idSucursalElement) ? idSucursalElement.GetString() : null;
