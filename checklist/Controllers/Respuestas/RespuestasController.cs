...
namespace checklist.Controllers.Respuestas
{
    public class RespuestasController : Controller
    {
        ...
        public async Task<ActionResult> Inicializa(string idEmpresa, string cadena, string empresa)
        {
            ...
            Opciones opc = await Utilerias.GetOpcion("02004000", idEmpresa, idRol, empresa, cadena);
        ...
        public async Task<IActionResult> GetData(string idLista, string idUsuario, string fechaInicia, string fechaFin, string idSucursal, string idEmpresa, string cadena, string empresa)
        {
            ...
            sb.Append("\"aaData\": [");
            sb.Append("[\"Lista\", \"Nombre Usuario\", \"Nombre Sucursal\", \"Fecha\", \"Acciones\"],");
        ...
        public async Task<IActionResult> GetDataListas(string idLista, string idUsuario, string idEmpresa, string cadena, string empresa)
        {
